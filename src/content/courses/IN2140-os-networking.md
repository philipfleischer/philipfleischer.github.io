...
## Home exam
The home exam was a substantial solo programming project requiring integration of multiple course topics: process management, IPC, socket communication, and concurrent data structures, all built in C with a CMake build.
