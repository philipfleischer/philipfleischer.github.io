...
**IN2120 - Introduction to Information Security** at UiO. A thorough introduction to the principles and practice of securing software systems and networks.
...
Security isn't a feature you bolt on at the end. It's a property you design in from the start. Understanding what an attacker can do with a weak JWT implementation or an unsalted password hash changes how you write code from day one.
</content>
